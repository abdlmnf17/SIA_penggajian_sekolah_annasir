                        ...
                        <table class="table table-bordered table-dark">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="card-text">{{ $gaji->honorMengajar->jam_mengajar }} : Rp.
                                            {{ number_format($gaji->honorMengajar->jumlah_mengajar, 2, ',', '.') }}</p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td <ul class="list-group mb-3">
                                        @foreach ($gaji->potongan as $potongans)
                                            <li class="list-group-item bg-dark text-white">{{ $potongans->nama_potongan }}:
                                                - Rp. {{ number_format($potongans->jumlah_potongan, 2, ',', '.') }}</li>
                                        @endforeach
                                        </ul>
                                    </td>
                                </tr>
