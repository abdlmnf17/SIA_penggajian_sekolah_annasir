              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('no_telepon') is-invalid @enderror" id="no_telepon" name="no_telepon" value="{{ old('no_telepon') }}" required>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('studi') is-invalid @enderror" id="studi" name="studi" value="{{ old('studi') }}" required>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('tgs') is-invalid @enderror" id="tgs" name="tgs" value="{{ old('tgs') }}" required>
